...
\begin{figure*}
  ...
  \includegraphics[width=0.45\textwidth]{nuplots/pks_nu_ckrel-1.pdf}
    \caption{Ratio of neutrino power spectra to the results of the default hybrid simulation parameters (HYBRID). Power spectra have been smoothed with an 11-pt rolling average to reduce scatter and shot noise has been subtracted. We show a variety of simulations with different parameters. (Left) HYBRID compared to neutrino particle simulations with $512^3$ neutrino particles (PARTICLE) and $1024^3$ neutrino particles (2xPARTICLE), as well as a hybrid simulation where all neutrino mass density is in particles after the switch-on time (HYBALL). (Right) HYBRID compared to hybrid simulations with parameters differing from the default (a cut-off velocity of $850$ km/s, switch-on time of $z=1$ and $512^3$ neutrino particles). We show neutrino cut-off velocities of $1000$ km/s (VCRIT) and $750$ km/s (VCRITLO), a switch-on time of $z=4$ (NUTIME) and $256^3$ neutrino particles (HYBSING).}
  \label{fig:vcrit}
\end{figure*}
