...
\end{tabular}
\end{center}
\caption{Table of simulation parameters. The AGN column shows whether AGN feedback is enabled. $\kappa_\mathrm{w}$ sets the wind velocity.
$50\%$ of the wind energy in the WARM simulation is deposited as thermal energy, as explained in the text.
}
...
Appendix showing how great our initial conditions are.
